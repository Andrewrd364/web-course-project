    ...
    return (
        <>
            <div style={{ display: 'flex', justifyContent: 'center', paddingTop: "150px", flexDirection: 'column', alignItems: 'center', marginBottom: '400px' }}>
                <img style={{ position: 'absolute', right: 0, zIndex: -1, top: "270px" }} src={bookTableBG} alt="" />
                <img style={{ position: 'absolute', right: 0, zIndex: -100, top: '-550px', width: '100%' }} src={curve4} alt="" />
